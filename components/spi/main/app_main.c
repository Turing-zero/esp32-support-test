...
void app_main(void)
{
    ...
    comm_status.rx_count = 0;
    comm_status.rx_index_end=0;
    comm_status.rx_index_start=0;
    comm_status.success_rate=0;
    ...
    while (1) {
        ...
        */
        ...
        //         comm_status.rx_index_start = recvbuf[1] | (recvbuf[2] << 8);
        //     } else {
        //         comm_status.rx_index_end = recvbuf[1] | (recvbuf[2] << 8);
        //     }
        ...
        //         printf("uart hit rate: %d\n",comm_status.success_rate);
        //     }
        // if (recvbuf[0]==0xab){
            printf("Received:");
            for(int i=0;i<num;++i){
        ...
        // }
            ...
            // for(int i =1;i<num;++i){
            //     if((int)recvbuf[i]==i)correct_num++;
            // }
            // printf("%d\n",correct_num);
            // if(correct_num==num){
            //     count++;
